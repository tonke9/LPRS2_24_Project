## Palm OS Generic 68K Makefile Engine for Eclipse v1.0.0
#
# Last edit: 7/22/04
#
...
LINKER_OUTPUT := $(OBJ_DIR)/$(DATABASE_NAME)
...
# XRD sources
$(OBJ_DIR)/%.trc : %.xrd makefile
	"$(TOOLS_DIR)PalmRC" -p $(TARGET_FORMAT) -makeDeps $(@D)/$(*F).deps $(RFLAGS) -locale $(LOCALE) $< -o $@
$(OBJ_DIR)/%.trc : %.XRD makefile
	"$(TOOLS_DIR)PalmRC" -p $(TARGET_FORMAT) -makeDeps $(@D)/$(*F).deps $(RFLAGS) -locale $(LOCALE) $< -o $@
...
$(SEGMENT_BASE).s $(SEGMENT_BASE).ld : Sections.def makefile
	$(MS) -b $(SEGMENT_BASE) Sections.def

# shared library rules
$(SLIB_DEF_ASSEMBLY) : $(SLIB_DEF_FILE) makefile
	$(SG) $<
	
$(SLIB_DEF_OBJ) : $(SLIB_DEF_ASSEMBLY) makefile
	$(AS) -o $@ $<
...
printvars :: FORCE
	...
	@echo "RESOURCE_PATHS"
	@echo $(RESOURCE_PATHS)
	@echo "MULTIPLE_CODE_SECTIONS"
	@echo $(MULTIPLE_CODE_SECTIONS)
	@echo "SEGMENT_BASE"
	@echo $(SEGMENT_BASE)
	@echo "MULTISEGMENT_LINKER_INPUT"
	@echo $(MULTISEGMENT_LINKER_INPUT)
	@echo "MULTISEGMENT_BUILD_INPUT"
	@echo $(MULTISEGMENT_BUILD_INPUT)
	@echo "OBJ_DIR"
	@echo $(OBJ_DIR)
	@echo "LINKER_OUTPUT"
...
depend :: FORCE
	@$(CC) $(INCLUDES) $(CFLAGS) $(DEPFLAG) $(SOURCES) | $(SOURCE_SEDSCRIPT) > .dependencies
